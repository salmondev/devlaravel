	...
	<div class="container">
		<div  class="row">
			...
			<div class="col-md-8">
				...
				<a href="alert?act=success" class="btn btn-primary"> success </a>
				<a href="alert?act=info" class="btn btn-info"> info </a>
				<a href="alert?act=warning" class="btn btn-warning"> warning </a>
				<a href="alert?act=danger" class="btn btn-danger"> danger </a>
